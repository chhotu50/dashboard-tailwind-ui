      ...
      <div className="mt-5 p-5 bg-white shadow-lg rounded">
        <div className="flex justify-between">
          ...
          <Link
            ...
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 lg:py-2 md:py-1.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
          >
            Add Product
          </Link>
        </div>
